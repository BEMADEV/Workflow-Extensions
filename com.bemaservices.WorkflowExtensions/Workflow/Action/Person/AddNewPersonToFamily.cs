    ...
    public class GetPersonFromFields : ActionComponent
    {
        ...
        public override bool Execute( RockContext rockContext, WorkflowAction action, Object entity, out List<string> errorMessages )
        {
            ...
            if ( attribute != null )
            {
                ...
                // BD 5/5/22: Fix null ref exception when family created in same workflow/rockContext instance by explicitly loading group type
                if ( familyGroup.GroupType == null ) { // Only load GroupType if we don't already have it
                    rockContext.Entry(familyGroup).Reference(fg => fg.GroupType).Load();
                }
                // End BD 5/5/22 Bugfix
